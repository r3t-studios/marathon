...
/// [`PhaseItem`](crate::render_phase::PhaseItem)s.
...
impl ViewRangefinder3d {
    ...
    /// Calculates the distance, or view-space `Z` value, for the given
    /// `translation`.
    #[inline]
    pub fn distance_translation(&self, translation: &Vec3) -> f32 {
        // NOTE: row 2 of the inverse view matrix dotted with the translation from the
        // model matrix gives the z component of translation of the mesh in
        // view-space
    ...
    pub fn distance(&self, transform: &Mat4) -> f32 {
        // NOTE: row 2 of the inverse view matrix dotted with column 3 of the model
        // matrix gives the z component of translation of the mesh in view-space
